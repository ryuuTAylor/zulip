...
To schedule a message that repeats on a daily, weekly, or monthly pattern, or
to send the same message to multiple channels or direct-message recipients
in one scheduled job, see
[Schedule a recurring or batch message](/help/schedule-a-recurring-or-batch-message).
